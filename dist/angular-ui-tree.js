                                    ...
                                    $q.when(scope.$treeScope.$callbacks.beforeDrop(dragEventArgs))
                                            ...
                                            .then(function (allowDrop) {
                                                if (allowDrop !== false && scope.$$allowNodeDrop && !outOfBounds) {
                                                    ...
                                                    //If is a main root change event dropped to especialDrop
                                                    if (dragEventArgs.dest.nodesScope.depth() == 0 ||
                                                            dragEventArgs.dest.nodesScope.depth() == 1) {
                                                        scope.especialDropRoot(dragEventArgs);
                                                    } else {
